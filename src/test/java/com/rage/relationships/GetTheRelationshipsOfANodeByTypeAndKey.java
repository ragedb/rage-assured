...
public class GetTheRelationshipsOfANodeByTypeAndKey extends BaseTest {

    @Test
    public void GetTheRelationshipsOfANodeByTypeAndKeyOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/all").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/out").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/in").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/out/LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/in/KNOWS").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/relationships/all/KNOWS&LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
