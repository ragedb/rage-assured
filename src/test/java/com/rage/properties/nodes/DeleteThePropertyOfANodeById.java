...
public class DeleteThePropertyOfANodeById extends BaseTest {
    
    @Test
    public void DeleteThePropertyOfANodeByIdOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/node/2050/property/name").
                then().
                assertThat().
                statusCode(204);
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/node/1027/property/name").
                then().
                assertThat().
                statusCode(204);
