...
public class SetThePropertiesOfARelationshipById extends BaseTest {

    @Test
    public void SetThePropertiesOfARelationshipByIdOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                ...
                put("/db/rage/relationship/1026/properties").
                then().
                assertThat().
                statusCode(204);
        ...
        given().
                ...
                when().
                body("{ \"awesome\" : true }").with().contentType(ContentType.JSON).
                put("/db/rage/relationship/2051/properties").
                then().
                assertThat().
                statusCode(204);
