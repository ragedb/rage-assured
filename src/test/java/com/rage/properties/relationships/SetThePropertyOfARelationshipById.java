...
public class SetThePropertyOfARelationshipById extends BaseTest {

    @Test
    public void SetThePropertyOfARelationshipByIdOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                body("5.5").with().contentType(ContentType.JSON).
                put("/db/rage/relationship/1026/property/weight").
                then().
                assertThat().
                statusCode(204);
        ...
        given().
                spec(requestSpec).
                when().
                body("true").with().contentType(ContentType.JSON).
                put("/db/rage/relationship/2051/property/awesome").
                then().
                assertThat().
                statusCode(204);
