...
public class DeleteThePropertiesOfARelationshipById extends BaseTest {

    @Test
    public void DeleteThePropertiesOfARelationshipByIdOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/relationship/2051/properties").
                then().
                assertThat().
                statusCode(204);
