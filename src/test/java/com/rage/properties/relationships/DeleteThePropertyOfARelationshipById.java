...
public class DeleteThePropertyOfARelationshipById extends BaseTest {

    @Test
    public void DeleteThePropertyOfARelationshipByIdOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/relationship/1026/property/weight").
                then().
                assertThat().
                statusCode(204);
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/relationship/2051/property/weight").
                then().
                assertThat().
                statusCode(204);
        given().
