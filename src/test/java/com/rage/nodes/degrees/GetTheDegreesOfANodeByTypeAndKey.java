...
public class GetTheDegreesOfANodeByTypeAndKey extends BaseTest {

    @Test
    public void GetTheDegreesOfANodeByTypeAndKeyOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/all").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/out").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/in").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/out/LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/in/KNOWS").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/degree/all/KNOWS&LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
