...
public class GetTheNeighborsOfANodeByTypeAndKey extends BaseTest {

    @Test
    public void GetTheNeighborsOfANodeByTypeAndKeyOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/all").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/out").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/in").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/out/LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/in/KNOWS").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/neighbors/all/KNOWS&LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
