...
package com.rage.nodes.connected;
...
public class GetConnectedOfANodeByTypeAndKey extends BaseTest {

    @Test
    public void GetTheConnectedOfANodeByTypeAndKeyOnEmptyGraph() {
        given().
                spec(requestSpec).
                when().
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/all").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/out").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/in").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/out/LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/in/KNOWS").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                get("/db/rage/node/User/Helene/connected/User/Max/all/KNOWS&LOVES").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
