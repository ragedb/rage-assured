...
public class FindNodesOfAType extends BaseTest {
    ...
    public void FindNodesOfATypeOnEmptyGraph() {
        ...
        given().
                spec(requestSpec).
                when().
                post("/db/rage/schema/nodes/User/properties/weight/double").
                then().
                assertThat().
                statusCode(201);
        ...
        given().
                spec(requestSpec).
                when().
                body("{ \"name\" : \"max\", \"age\" : 42, \"weight\": 230 }").with().contentType(ContentType.JSON).
                ...
                body("properties.weight", is(230)).
                body("properties.name", is("max"));

        given().
                spec(requestSpec).
                when().
                body("{ \"name\" : \"helene\", \"age\" : 41, \"weight\": 180.0 }").with().contentType(ContentType.JSON).
        ...
        given().
                spec(requestSpec).
                when().
                body("{ \"name\" : \"alex\", \"age\" : 41, \"weight\": 200.0 }").with().contentType(ContentType.JSON).
        ...
        given().
                spec(requestSpec).
                when().
                body("{ \"name\" : \"gabi\", \"age\" : 41, \"weight\": 130.0 }").with().contentType(ContentType.JSON).
        ...
        given().
                spec(requestSpec).
                when().
                body("{ \"name\" : \"penny\", \"age\" : 2, \"weight\": 10.0 }").with().contentType(ContentType.JSON).
        ...
        given().
                spec(requestSpec).
                when().
                delete("/db/rage/node/User/Penny/property/weight").
                then().
                assertThat().
                statusCode(204);
        ...
        given().
                spec(requestSpec).
                when().
                post("/db/rage/nodes/User/weight/IS_NULL").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                post("/db/rage/nodes/User/weight/NOT_IS_NULL").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                body("230.0").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/EQ").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
                ...
                body("[0].properties.weight", is(230)).
                body("[0].properties.name", is("max"));

        given().
                spec(requestSpec).
                when().
                body("230").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/EQ").
                then().
                assertThat().
                statusCode(200).
        ...
        given().
                spec(requestSpec).
                when().
                body("225").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/GT").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                body("200").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/GTE").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                ...
                when().
                body("200").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/LT").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                ...
                when().
                body("200").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/LTE").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                ...
                when().
                body("200").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/NEQ").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                body("100").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/weight/GTE?limit=1&skip=2").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
        ...
        given().
                spec(requestSpec).
                when().
                body("\"max\"").with().contentType(ContentType.JSON).
                post("/db/rage/nodes/User/name/EQ").
                then().
                assertThat().
                statusCode(200).
                contentType(equalTo("application/json")).
